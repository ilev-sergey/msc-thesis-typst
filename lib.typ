...
#let template(
  ...
  organization: [Федеральное государственное автономное образовательное учреждение \ высшего образования «Московский физико-технический институт \ (национальный исследовательский университет)»],
  ...
  organization-short: "МФТИ",
  supervisor-first-name: "Анастасия Александровна",
  supervisor-last-name: "Чуприк",
  ...
  // show: codly-init.with() // Disabled - codly incompatible with current Typst version
  // codly(languages: languages) // Disabled - codly incompatible with current Typst version
