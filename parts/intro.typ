...
Альтернативная классическому @FeFET концепция @сэ памяти --- #gls("FeMFET", display: "FeFET топологии 1T-1C") --- состоит из одного транзистора и одного конденсатора, подключённого к затвору транзистора. Такой подход позволяет избежать наличия интерфейса @сэ\--полупроводник, характеризующегося высокой плотностью поверхностных состояний, динамика перезарядки которых ограничивает рабочую частоту транзистораи значительно повысить циклическую стойкость устройства. Однако данная конструкция имеет свои недостатки. К ним относится существование делителя напряжения между емкостью транзистора и сегнетоэлектрического конденсатора, что при неоптимальном соотношении емкостей может приводить к неполному переключению поляризации и сужению окна памяти, а также наличие плавающего затвора, способного накапливать инжектированный заряд и, тем самым, неконтролируемо изменять характеристики FeFET.
В работе экспериментально исследовано влияние двух ключевых факторов на запоминающие свойства FeFET структур типа 1T-1C: инжекции заряда в плавающий затвор и соотношения емкостей транзистора и конденсатора. В частности, проводится анализ влияния размеров составляющих элементов на передаточные характеристики, определяется вклад инжекции заряда в окно памяти, а также оптимизируются рабочие параметры для достижения наилучших характеристик ячеек памяти.
